...
ACTIONS:
 ...
 setpass, setkey, setpassword
    ...
    OPTIONAL PARAMETER(S):
        --key <KEY_ID>"
        This action is used to key in GPG passphrase and validate it. If
        the passphrase is valid, it will show information about the cache duration.
        Note that this command will automatically start gpg-agent
